...
// Ensure mysqli extension is available (especially for CLI runs)
if (!extension_loaded('mysqli')) {
    $msg = 'PHP mysqli extension is not loaded. Install php-mysqli (or run inside Docker).';
    if (PHP_SAPI === 'cli') {
        fwrite(STDERR, $msg . "\n");
        exit(1);
    } else {
        ...
        exit('Internal Server Error: DB driver not available');
    }
}
...
try {
    ...
    $GLOBALS["dbcon"] = mysqli_connect("p:".DB_HOST, DB_USER, DB_PASSWORD, DB_NAME, (int)$dbPort);
