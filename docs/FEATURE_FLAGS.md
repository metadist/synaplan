...
| 5 | Desktop client (public beta) | **Channels → Desktop**: pairing codes, connected computers, job queue; download link to [synaplan-desktop](https://github.com/metadist/synaplan-desktop). When off, a paired computer cannot chat; the response says Synaplan Desktop is turned off. | `DESKTOP_AGENT.ENABLED` | `FEATURE_DESKTOP_AGENT_ENABLED` | on | [#1669](https://github.com/metadist/synaplan/pull/1669), [#1808](https://github.com/metadist/synaplan/pull/1808) |
