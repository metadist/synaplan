...
| 5 | Secure compute (file work) | Chat card for short Python or Node file work. Needs `COMPUTE_URL` + `COMPUTE_TOKEN` **and** this flag. Off = absent, no teaser. | `COMPUTE.ENABLED` | `FEATURE_COMPUTE_ENABLED` | **off** | Wave 5 A3/B1 |
