...
Two comparison rules keep the same-mode bucket honest (both from #1772):
...
Current entries: Jina Reranker v2 Multilingual (`jina:jina-reranker-v2-base-multilingual`, LiteLLM 0.018 vs official 0.05 — see the 2026-09-10 drift log).
