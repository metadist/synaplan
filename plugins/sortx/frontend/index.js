    ...
    el.innerHTML = `
      <div style="padding: 20px; font-family: sans-serif;">
        ...
        <p style="color: var(--txt-primary, #333); margin-bottom: 8px;">
          SortX is an AI-powered document classification plugin for local file sorting.
        </p>
        <div style="background: var(--bg-card, #f5f5f5); padding: 16px; border-radius: 8px; margin-top: 16px; border: 1px solid var(--border-light, #e0e0e0);">
          ...
          <ul style="margin-top: 8px; font-size: 14px; color: var(--txt-secondary, #666); list-style: none; padding: 0;">
            ...
            <li style="margin-bottom: 8px;">✅ <strong>Version:</strong> 1.0.0</li>
        ...
        <div style="background: var(--bg-card, #f5f5f5); padding: 16px; border-radius: 8px; margin-top: 16px; border: 1px solid var(--border-light, #e0e0e0);">
          ...
          <ul style="margin-top: 8px; font-size: 14px; color: var(--txt-secondary, #666); list-style: none; padding: 0;">
            <li style="margin-bottom: 8px;">📄 <code style="background: var(--bg-chip, #f0f0f0); padding: 2px 6px; border-radius: 4px;">POST /classify</code> - Classify document text</li>
            ...
            <li style="margin-bottom: 8px;">📄 <code style="background: var(--bg-chip, #f0f0f0); padding: 2px 6px; border-radius: 4px;">GET /categories</code> - Get categories</li>
          </ul>
        </div>
