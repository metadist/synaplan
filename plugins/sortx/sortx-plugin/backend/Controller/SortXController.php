...
You are a document classification assistant. Analyze the document and categorize it.

Categories:
- contract: Legal agreements, contracts, invoices, leases, terms of service
- letter: Personal or business correspondence, emails, official letters
- research: Academic papers, research documents, technical documentation
- miscellaneous: Other categorized documents that don't fit above
- unknown: Documents that cannot be classified with confidence
...
{"category": "category_key", "subcategory": "optional", "confidence": 0.0-1.0, "reasoning": "brief explanation"}

Rules:
1. Use "unknown" if confidence would be below 0.5
2. Consider filename as a hint but prioritize content
3. Invoices and bills are typically contract/invoice subcategory
PROMPT;
        ...
        content: new OA\JsonContent(
            properties: [
                ...
                new OA\Property(
                    ...
                    type: 'object',
                    properties: [
                        new OA\Property(property: 'category', type: 'string', example: 'contract'),
                        new OA\Property(property: 'subcategory', type: 'string', example: 'invoice'),
        ...
        return $this->json([
            ...
            'categories' => [
                [
                    ...
                    'subcategories' => ['ongoing', 'expired', 'invoice', 'lease', 'insurance'],
                ],
                [
                    'key' => 'letter',
                    'name' => 'Letter',
                    'description' => 'Personal and business correspondence',
                    'subcategories' => ['incoming', 'outgoing', 'official', 'personal'],
                ],
                [
                    'key' => 'research',
                    'name' => 'Research',
                    'description' => 'Research documents and papers',
                    'subcategories' => ['academic', 'technical', 'report'],
                ],
                [
                    'key' => 'miscellaneous',
                    'name' => 'Miscellaneous',
                    'description' => 'Other categorized documents',
                    'subcategories' => [],
                ],
                [
                    'key' => 'unknown',
    ...
    private function parseClassificationResponse(string $response): array
    {
        ...
        return [
            ...
            'subcategory' => $decoded['subcategory'] ?? null,
