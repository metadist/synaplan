...
--
-- Host: localhost
-- Erstellungszeit: 10. Sep 2025 um 11:56
...
(75, 'Ollama', 'llava:13b', 'pic2text', 1, 'llava:13b', 0, '-', 0, '-', 10, 1, '{\"description\":\"Local Ollama image processing and text extraction\",\"prompt\":\"Describe image! List the texts in the image, if possible. If not, describe the image in short.\",\"params\":{\"model\":\"llava:13b\"}}');
