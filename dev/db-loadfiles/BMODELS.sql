...
--
-- Host: db:3306
-- Erstellungszeit: 04. Sep 2025 um 08:23
...
--
-- Tabellenstruktur für Tabelle `BMODELS`
--
...
(2, 'Ollama', 'Llama 3.3 70b', 'chat', 1, 'llama3.3:70b', 0.79, 'per1M', 0.79, 'per1M', 6, 1, '{\"description\":\"Local model on synaplans company server in Germany. Metas Llama Model Version 3.3 with 70b parameters. Heavy load model and relatively slow, even on a dedicated NVIDIA card. Yet good quality!\"}'),
(3, 'Ollama', 'deepseek-r1:32b', 'chat', 1, 'deepseek-r1:32b', 0.55, 'per1M', 0, '-', 6, 1, '{\"description\":\"Local model on synaplans company server in Germany. DeepSeek R1 is a Chinese Open Source LLM. This is the bigger version with 32b parameters. A bit slower, but more accurate!\"}'),
...
(53, 'Groq', 'deepseek-r1-distill-llama-70b', 'chat', 1, 'deepseek-r1-distill-llama-70b', 0.75, 'per1M', 0.99, 'per1M', 8, 0, '{\"description\":\"Groq DeepSeek R1 Distill on Llama\",\"prompt\":\"\",\"params\":{\"model\":\"deepseek-r1-distill-llama-70b\"}}'),
...
--
-- Indizes für die Tabelle `BMODELS`
--
ALTER TABLE `BMODELS`
  ADD PRIMARY KEY (`BID`),
  ADD KEY `BTAG` (`BTAG`);
...
--
-- AUTO_INCREMENT für Tabelle `BMODELS`
--
ALTER TABLE `BMODELS`
  MODIFY `BID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
COMMIT;
