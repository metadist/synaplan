...
(1, 'Ollama', 'deepseek-r1:14b', 'chat', 1, 'deepseek-r1:14b', 0.092, 'per1M', 0.46, 'per1M', 7, 8, 0, 0, NULL, '{\"description\":\"Deprecated: no longer on GPU server. Use gpt-oss:120b or qwen3.5:35b.\",\"features\":[\"reasoning\"]}'),
(2, 'Ollama', 'Llama 3.3 70b', 'chat', 1, 'llama3.3:70b', 0.54, 'per1M', 0.73, 'per1M', 9, 1, 0, 0, NULL, '{\"description\":\"Deprecated: no longer on GPU server. Use gpt-oss:120b or qwen3.5:35b.\"}'),
(3, 'Ollama', 'deepseek-r1:32b', 'chat', 1, 'deepseek-r1:32b', 0.69, 'per1M', 0.91, '-', 8, 8, 0, 0, NULL, '{\"description\":\"Deprecated: no longer on GPU server. Use gpt-oss:120b or qwen3.5:35b.\",\"features\":[\"reasoning\"]}'),
(6, 'Ollama', 'mistral', 'chat', 1, 'mistral:7b', 0.095, 'per1M', 0.475, '-', 5, 0, 0, 0, NULL, '{\"description\":\"Deprecated: no longer on GPU server. Use gpt-oss:120b or qwen3.5:35b.\"}'),
...
(13, 'Ollama', 'bge-m3:latest', 'vectorize', 0, 'bge-m3:latest', 0.19, 'per1M', 0, '-', 6, 1, 0, 1, NULL, '{\"description\":\"Vectorize text into synaplans MariaDB vector DB (local) for RAG. Default embedding model on GPU server.\",\"params\":{\"model\":\"bge-m3:latest\",\"input\":[]}}'),
...
(78, 'Ollama', 'gpt-oss:20b', 'chat', 1, 'gpt-oss:20b', 0.12, 'per1M', 0.6, 'per1M', 9, 1, 0, 0, NULL, '{\"description\":\"Deprecated: no longer on GPU server. Use gpt-oss:120b or qwen3.5:35b.\",\"params\":{\"model\":\"gpt-oss:20b\"},\"meta\":{\"context_window\":\"128k\",\"license\":\"Apache-2.0\",\"quantization\":\"MXFP4\"}}'),
(79, 'Ollama', 'gpt-oss:120b', 'chat', 1, 'gpt-oss:120b', 0.05, 'per1M', 0.25, 'per1M', 9, 1, 0, 1, NULL, '{\"description\":\"Local model on GPU server 10.0.1.11. OpenAI\\u0027s open-weight GPT-OSS (120B). 128K context, Apache-2.0 license; supports tools\\/agentic use cases.\",\"params\":{\"model\":\"gpt-oss:120b\"},\"meta\":{\"context_window\":\"128k\",\"license\":\"Apache-2.0\",\"quantization\":\"MXFP4\"}}'),
(172, 'Ollama', 'Qwen 3.5 35B', 'chat', 1, 'qwen3.5:35b', 0.15, 'per1M', 0.4, 'per1M', 9, 1, 0, 1, NULL, '{\"description\":\"Local model on GPU server 10.0.1.11. Alibaba Qwen 3.5 35B - strong reasoning and coding.\",\"params\":{\"model\":\"qwen3.5:35b\"},\"meta\":{\"context_window\":\"32768\"}}'),
...
(173, 'Google', 'Nano Banana 2 (3.1 Flash Image)', 'text2pic', 1, 'gemini-3.1-flash-image-preview', 0.1, 'per1M', 0.4, 'per1M', 10, 1, 0, 1, NULL, '{\"description\":\"Google Nano Banana 2 - advanced image generation and editing. Up to 4K, 14 reference images, Google Search grounding.\",\"params\":{\"model\":\"gemini-3.1-flash-image-preview\"},\"features\":[\"image\",\"pic2pic\"],\"meta\":{\"max_reference_images\":14}}'),
(124, 'Ollama', 'nemotron-3-nano', 'chat', 1, 'nemotron-3-nano', 0.092, 'per1M', 0.46, 'per1M', 8, 8, 0, 0, NULL, '{\"description\":\"Deprecated: no longer on GPU server. Use gpt-oss:120b or qwen3.5:35b.\",\"features\":[\"reasoning\"]}'),
...
--
ALTER TABLE `BMODELS`
  MODIFY `BID` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=174;
COMMIT;
