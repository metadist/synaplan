...
output_var "APP_URL" "http://localhost:8000"
echo ""
...
echo ""
output_var "DATABASE_WRITE_URL" "mysql://synaplan_user:synaplan_password@db:3306/synaplan?serverVersion=mariadb-12.2.2&charset=utf8mb4"
output_var "DATABASE_READ_URL" "mysql://synaplan_user:synaplan_password@db:3306/synaplan?serverVersion=mariadb-12.2.2&charset=utf8mb4"
