...
[`../20260907_ux_user_flows/connect-platform.md`](../20260907_ux_user_flows/connect-platform.md).
...
| `_devextras/planning/20260903_iam/01_sprint_1_groups_core.md` §2.8 (`PeopleView.vue`, `/admin/people`), `_devextras/testing/desktop/pair.sh` | Operate → People (from IAM S1) hosts the admin tab; harness shape to copy |
