...
| 4 | **Frictionless Onboarding & the Token Wallet** — persistent prepaid **credit wallet** (welcome grant unlocks everything; fixed €19.95/€49.95 top-up packs via Stripe web + Apple/Google IAP with an internal +25% app surcharge; non-refundable AI-compute credit), built on the existing cost-budget/markup/IAP spine; Turnstile + verification anti-abuse | [`05_onboarding-conversion-flow.md`](./05_onboarding-conversion-flow.md) | P1 | Planned (wallet rework 2026-06-30) |
