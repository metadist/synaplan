...
U3 and U7 in [`../20260907_ux_user_flows.md`](../20260907_ux_user_flows.md):
...
| `_devextras/planning/20260903_tools_approval_workflows/00_master_plan.md` §0 row 1 | `ToolDescriptor` / `ToolRegistry` (tagged `app.tool.source`) — the adapter target |
