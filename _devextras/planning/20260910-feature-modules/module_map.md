...
Inventory compiled from the working tree with the read-only searches listed below (`rg`, file reads); no service was started and no build was run to produce it. The removals it recommends (FM2/FM3) and the ownership test (FM4) landed with S1.
