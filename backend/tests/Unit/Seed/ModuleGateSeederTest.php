...
final class ModuleGateSeederTest extends TestCase
{
    ...
    public function testOneGlobalRowPerModuleWithShippedDefaults(): void
    {
        ...
        $on = ['GATE_TIKA', 'GATE_DOCLING', 'GATE_OFFICE_CONVERT', 'GATE_SEARXNG', 'GATE_PIPER_TTS', 'GATE_LOCAL_AI', 'GATE_HIGGSFIELD', 'GATE_GOOGLE_AI', 'GATE_THEHIVE', 'GATE_STRIPE_BILLING'];
