...
final readonly class MultitaskConfigSeeder
{
    ...
    public function seed(): SeedResult
    {
        $rows = [
            ...
            // single-deliverable turns. ON so the latency win is the default;
            // the row exists so it can be flipped without a deploy.
            ['ownerId' => 0, 'group' => MultitaskRoutingConfig::CONFIG_GROUP, 'setting' => MultitaskRoutingConfig::KEY_PLAN_ONLY_MULTI_INTENT, 'value' => '1'],
        ];
