...
final readonly class BrandingConfigSeeder
{
    ...
    public function seed(): SeedResult
    {
        ...
        $rows = [
            ...
            ['ownerId' => 0, 'group' => $g, 'setting' => BrandingService::KEY_PRIMARY_COLOR_DARK,   'value' => BrandingService::DEFAULT_PRIMARY_COLOR_DARK],
            ['ownerId' => 0, 'group' => $g, 'setting' => BrandingService::KEY_SECONDARY_COLOR_DARK, 'value' => BrandingService::DEFAULT_SECONDARY_COLOR_DARK],
            ['ownerId' => 0, 'group' => $g, 'setting' => BrandingService::KEY_ACCENT_COLOR_DARK,    'value' => BrandingService::DEFAULT_ACCENT_COLOR_DARK],
