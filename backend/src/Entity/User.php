...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * Forces the next sign-in to end in a password change before anything else
     * works. Set for accounts whose password was generated by a deployment
     * rather than chosen by a human — an image that boots with a per-instance
     * random admin password must not keep that password in use (AWS Marketplace
     * AMI policy requires a one-time initial credential).
     */
    #[ORM\Column(name: 'BMUSTCHANGEPW', type: 'boolean', options: ['default' => false])]
