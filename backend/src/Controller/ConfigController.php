            ...
            properties: [
                ...
                new OA\Property(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'desktopAgentEnabled', type: 'boolean', example: false, description: 'When true, the Synaplan Desktop pairing surface (Manage → Channels → Synaplan Desktop) and desktop job APIs are exposed. On by default; pin with FEATURE_DESKTOP_AGENT_ENABLED or the Admin Features tab.'),
