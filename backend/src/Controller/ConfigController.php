            ...
            properties: [
                ...
                new OA\Property(
                    ...
                    properties: [
                        ...
                        new OA\Property(property: 'landingPage', type: 'string', example: '', description: 'Logged-out landing route name; empty string keeps the default landing'),
                        new OA\Property(property: 'defaultRoute', type: 'string', example: '', description: 'Post-login default route name; empty string keeps the default route'),
