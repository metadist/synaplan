...
final class FileSendController extends AbstractController
{
    ...
    #[OA\Post(
        ...
        summary: 'Deliver a file to a destination (email, share link, WebDAV folder, Dropbox, CalDAV calendar, or Outlook calendar)',
        tags: ['Files'],
        ...
        requestBody: new OA\RequestBody(
            ...
            content: new OA\JsonContent(
                ...
                properties: [
                    new OA\Property(property: 'destination', type: 'string', enum: ['email', 'share_link', 'webdav', 'dropbox', 'caldav', 'm365_calendar'], example: 'email'),
                    new OA\Property(property: 'subject', type: 'string'),
                    new OA\Property(property: 'body', type: 'string'),
                    new OA\Property(property: 'expiry_days', type: 'integer', example: 7),
                    new OA\Property(property: 'connection_id', type: 'integer', description: 'Required for webdav/dropbox/caldav/m365_calendar: the connection to deliver through', example: 12),
                ]
            )
        ),
        responses: [
