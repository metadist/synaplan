...
class ModelCatalog
{
    ...
    private const MODELS = [
        ...
        [
            ...
            'selectable' => 1,
            'active' => 1,
            'providerId' => 'bytedance/seedream/v4/text-to-image',
            'priceIn' => 0,
            'inUnit' => '-',
            'priceOut' => 0.04,
            'outUnit' => 'perpic',
            ...
            'rating' => 2,
            'json' => [
                'description' => 'ByteDance Seedream v4 (via Higgsfield) - fast text-to-image model with strong prompt adherence. Up to 2K resolution, multiple aspect ratios.',
                'params' => ['model' => 'bytedance/seedream/v4/text-to-image'],
                'allowed_resolutions' => ['720p', '1080p', '2K'],
                'default_resolution' => '1080p',
                'features' => ['text2pic'],
            ],
        ...
        [
            ...
            'selectable' => 1,
            'active' => 1,
            'providerId' => 'bytedance/seedance/v1/pro/image-to-video',
            'priceIn' => 0,
            'inUnit' => '-',
            'priceOut' => 0.55,
            'outUnit' => 'per_second',
            ...
            'rating' => 2,
            'json' => [
                'description' => 'ByteDance Seedance v1 Pro (via Higgsfield) - professional-grade image-to-video. Great for portrait micro-expressions and subject motion.',
                'params' => ['model' => 'bytedance/seedance/v1/pro/image-to-video'],
                'pricing_mode' => 'per_second',
                'allowed_resolutions' => ['720p', '1080p'],
                'default_resolution' => '1080p',
