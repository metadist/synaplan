...
class ModelCatalog
{
    ...
    private const MODELS = [
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'Anthropic Claude Sonnet 5 for memory extraction. Highest extraction quality; significantly more expensive than the Groq/Ollama gpt-oss options — pick this only when extraction accuracy matters more than latency.',
                'max_tokens' => 4096,
                'is_system' => true,
        ...
        // ==================== ANTHROPIC MODELS ====================
        // Retired generations (BIDs kept out of the catalog, rows deactivated in
        // existing installs by Version20260727120000): Claude Sonnet 4.5
        // (109/112), Claude Opus 4.6 (160/164), Claude Sonnet 4.6 (161/163) and
        // Claude Opus 4.7 (165/166). Never reuse those BIDs — BMESSAGES still
        // references them.
        [
            'id' => 162,
            'service' => 'Anthropic',
        ...
        [
            // Snapshot 2026-07-27 (https://platform.claude.com/docs/en/about-claude/models/overview).
            // Claude Opus 5 — Anthropic's recommended starting point for complex
            // agentic coding and enterprise work. Adaptive thinking, `effort`
            // defaults to high on the API, and (like Opus 4.7+) no `temperature`.
            'id' => 257,
            'service' => 'Anthropic',
            'name' => 'Claude Opus 5',
            'tag' => 'chat',
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'Z.ai GLM-5.2 via TrustedTokens (Germany) — frontier open-weights model for long-horizon agentic coding. Reasoning + tools. ~230K context.',
                'max_tokens' => 32768,
                'params' => ['model' => 'zai-org/GLM-5.2'],
                'features' => ['reasoning', 'tool_use', 'multilingual'],
        ...
        [
            ...
            'selectable' => 1,
            'active' => 1,
            'providerId' => 'Qwen/Qwen3.6-35B-A3B-FP8',
            'priceIn' => 0.25,
            'inUnit' => 'per1M',
            'priceOut' => 1.50,
            'outUnit' => 'per1M',
            ...
            'rating' => 1,
            'json' => [
                'description' => 'Qwen3.6 35B-A3B FP8 via TrustedTokens (Germany) — lightweight multimodal agent with reasoning and tools. ~262K context.',
                'max_tokens' => 32768,
                'params' => ['model' => 'Qwen/Qwen3.6-35B-A3B-FP8'],
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'Qwen3.6 35B vision via TrustedTokens (Germany) — image understanding and OCR-style extraction on sovereign EU infrastructure.',
                'prompt' => 'Describe the image in detail. Extract any text you see.',
                'params' => ['model' => 'Qwen/Qwen3.6-35B-A3B-FP8'],
                'features' => ['vision', 'ocr', 'multilingual'],
                'cache_read_price_per_1M' => 0.05,
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'OpenAI GPT OSS 120B via TrustedTokens (Germany) — open-weight model for reasoning, agentic tasks, and developer use. ~131K context.',
                'max_tokens' => 16384,
                'params' => ['model' => 'openai/gpt-oss-120b'],
