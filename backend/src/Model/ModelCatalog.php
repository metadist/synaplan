...
class ModelCatalog
{
    ...
    private const MODELS = [
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'OpenAI\'s famous text to image model on OpenAI cloud. Costs are 1:1 funneled.',
                'params' => ['model' => 'dall-e-3', 'size' => '1024x1024', 'quality' => 'standard', 'style' => 'vivid'],
            ],
        ],
        [
            'id' => 29,
            ...
            'rating' => 1,
            'json' => [
                'description' => 'OpenAI\'s powerful image generation model on OpenAI cloud. Costs are 1:1 funneled.',
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'OpenAI\'s text model',
        ...
        [
            ...
            'json' => [
                ...
                'params' => ['model' => 'o3', 'reasoning_effort' => 'high'],
                'features' => ['reasoning'],
            ],
        ],
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'OpenAI\'s GPT 5 model - latest release',
                'params' => ['model' => 'gpt-5'],
            ],
        ],
        [
            ...
            'json' => [
                ...
                'params' => ['model' => 'o3-pro', 'reasoning_effort' => 'high'],
            ],
        ],
        [
            'id' => 73,
        ...
        [
            ...
            'json' => [
                ...
                'params' => ['model' => 'dall-e-2', 'size' => '1024x1024'],
            ],
        ],
        [
            'id' => 87,
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'OpenAI\'s GPT 5.2 model - more reasoning',
                'params' => ['model' => 'gpt-5'],
            ],
        ],
        // ==================== GOOGLE MODELS ====================
        ...
        [
            ...
            'rating' => 1,
            'json' => [
                'description' => 'Google imagen-3.0-generate-002',
        ...
        [
            'id' => 100,
            'service' => 'triton',
            'name' => 'mistral-7b (streaming)',
            'tag' => 'chat',
            'selectable' => 1,
            'active' => 1,
            'providerId' => 'mistral-streaming',
            'priceIn' => 0,
            'inUnit' => 'per1M',
            'priceOut' => 0,
            'outUnit' => 'per1M',
            ...
            'rating' => 0.5,
            'json' => [
                'description' => 'Triton Inference Server model with TensorRT-LLM backend',
        ...
        [
            ...
            'rating' => 0.5,
            'json' => [
                'description' => 'Triton Inference Server model with PyTorch CPU backend',
                'features' => ['cpu', 'streaming'],
                'supportsStreaming' => true,
            ],
        ],
    ];
