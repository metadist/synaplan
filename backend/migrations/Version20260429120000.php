 ...
 *
 * Naming: this migration was originally authored as `Version20260429000000` but
 * collided on `main` with the DBAL-4 column-comment cleanup migration that landed
 * with the same timestamp. Renamed to `Version20260429120000` so it runs strictly
 * after the schema-cleanup pass, which is the safer ordering.
 */
