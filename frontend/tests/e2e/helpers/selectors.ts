...
export const selectors = {
  ...
  chat: {
    ...
    messageImage: '[data-testid="section-message-image"]',
    ...
    modelDefault: '[data-testid="btn-model-default"]',
    modelOption: (id: number) => `[data-testid="btn-model-${id}"]`,
    modelOptionAny: '[data-testid^="btn-model-"]',
  },
  share: {
