<template>
  <div
    ...
    data-testid="page-verify-email-callback"
  >
    <div class="w-full max-w-md">
      ...
      <div class="surface-card p-8 text-center" data-testid="section-verify-card">
        <div v-if="loading" data-testid="state-loading">
          <div
            class="w-16 h-16 mx-auto rounded-full bg-blue-500/10 flex items-center justify-center mb-6"
          >
            <svg
        ...
        <div v-else-if="verified" data-testid="state-success">
          <div
            class="w-16 h-16 mx-auto rounded-full bg-green-500/10 flex items-center justify-center mb-6"
          >
            <svg
        ...
        <div v-else data-testid="state-error">
          <div
            class="w-16 h-16 mx-auto rounded-full bg-red-500/10 flex items-center justify-center mb-6"
          >
