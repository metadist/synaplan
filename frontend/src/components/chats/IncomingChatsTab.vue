<template>
  <div data-testid="page-chats-incoming">
    <div v-if="iamGroupsEnabled" class="flex justify-end mb-4">
      <router-link
        to="/groups"
...
onMounted(async () => {
  ...
  // Opening this tab is what "seeing" means: the red dot goes away, while the
