<template>
  <header class="bg-header relative z-50 border-b border-black/[0.04] dark:border-white/[0.04]" data-testid="comp-app-header">
    <div class="flex items-center justify-between px-4 sm:px-6 py-4" data-testid="section-header-bar">
