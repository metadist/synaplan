  ...
  <Teleport to="#app">
    <Transition name="modal">
      ...
      >
        ...
        <!-- Modal Content -->
        <div
          class="relative surface-elevated max-w-md w-full p-6 animate-in"
        ...
        >
          ...
          <div class="flex justify-center mb-4">
            <div class="relative">
              <div
                class="absolute inset-0 bg-gradient-to-br from-brand/20 to-brand/5 rounded-full blur-xl"
              ></div>
              <div
              ...
              >
                <svg
                  class="w-8 h-8"
                  :class="limitType === 'lifetime' ? 'text-orange-500' : 'txt-brand'"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
          ...
          <div class="surface-card p-4 mb-6 space-y-3" data-testid="section-usage">
            <div class="flex items-center justify-between text-sm">
              ...
              <span class="font-semibold txt-primary"
                >{{ used }} / {{ formatLimit(currentLimit) }}</span
              >
            </div>

            <!-- Progress Bar -->
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2">
              <div class="h-2 rounded-full transition-all bg-red-500" style="width: 100%"></div>
            </div>
          ...
          <div class="flex flex-col gap-3">
            ...
            >
              ...
              {{ $t('limitReached.topup.button', { amount: topupStepEur }) }}
            </button>
...
const handleTopup = async () => {
  ...
  try {
    const session = await subscriptionApi.createTopupSession(1)
    if (session.url) {
