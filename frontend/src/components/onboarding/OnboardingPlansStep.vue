  ...
  <div class="w-full max-w-sm text-center" data-testid="section-onboarding-plans">
    ...
    <div class="mt-5 space-y-2.5 text-left">
      ...
      <template v-if="plans.length > 0">
        ...
        <button
          class="w-full py-2 rounded-xl btn-primary font-semibold text-sm transition-all duration-200 hover:shadow-lg hover:shadow-brand/20 active:scale-[0.98] onb-enter-6"
      ...
      <!-- Guest option after the plans (just-try-it below business): the app is
           never walled behind a purchase, but the paid plans get the visual
           lead now (primary CTA above), so the guest entry is the calm
           secondary action here. -->
      <div
        class="p-3.5 rounded-2xl surface-card ring-1 ring-black/[0.04] dark:ring-white/[0.05] onb-enter-6"
      ...
      >
        ...
        <button
          class="mt-2.5 w-full py-2 rounded-xl btn-secondary font-semibold text-sm transition-all duration-200 active:scale-[0.98]"
